#!/usr/bin/env python3
"""
Gemini CLI notification hook adapter.
...
from amplifier.utils.notifications.models import GeminiCodeHookInput  # noqa: E402
...
def main():
    ...
    try:
        ...
        debug = os.environ.get("GEMINI_HOOK_DEBUG", "").lower() in ("true", "1", "yes")
