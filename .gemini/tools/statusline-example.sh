...
# Enhanced Gemini CLI Status Line Script
# =========================================
# This script creates a custom status line for Gemini CLI that displays:
...
# 1. Run `/statusline` in Gemini CLI to let it customize this for your environment
# 2. Or manually configure by adding to your ~/.gemini/settings.json:
#    {
#      "statusLine": {
#        "type": "command",
...
# Read JSON input from Gemini CLI (sent via stdin)
input=$(cat)
