...
- ✅ Install the Gemini CLI (`@anthropic-ai/gemini-code`)
...
If the `gemini` command is not found, the post-create script may have failed. Check the logs at `/tmp/devcontainer-post-create.log` for details, or manually run:
