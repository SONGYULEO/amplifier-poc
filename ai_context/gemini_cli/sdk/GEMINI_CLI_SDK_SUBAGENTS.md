...
> Working with subagents in the Gemini CLI SDK

Subagents in the Gemini CLI SDK are specialized AIs that are orchestrated by the main agent.
...
- **Project-level**: `.gemini/agents/*.md` - Available only in the current project
...
When using the Gemini CLI SDK, subagents defined in the filesystem are automatically available. Gemini CLI will:

1. **Auto-detect subagents** from `.gemini/agents/` directories
...
For comprehensive examples of subagents including code reviewers, test runners, debuggers, and security auditors, see the [main Subagents guide](/en/docs/gemini-code/sub-agents#example-subagents). The guide includes detailed configurations and best practices for creating effective subagents.
...
- [Main Subagents Guide](/en/docs/gemini-code/sub-agents) - Comprehensive subagent documentation
- [SDK Configuration Guide](/en/docs/gemini-code/sdk/sdk-configuration-guide) - Overview of configuration approaches
- [Settings](/en/docs/gemini-code/settings) - Configuration file reference
- [Slash Commands](/en/docs/gemini-code/slash-commands) - Custom command creation
