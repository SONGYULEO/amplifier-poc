...
> Learn how to customize Gemini's behavior by modifying system prompts using three approaches - output styles, appendSystemPrompt, and customSystemPrompt.

System prompts define Gemini's behavior, capabilities, and response style. The Gemini CLI SDK provides three ways to customize system prompts: using output styles (persistent, file-based configurations), appending to the default prompt, or replacing it entirely.

## Understanding system prompts

A system prompt is the initial instruction set that shapes how Gemini behaves throughout a conversation. Gemini CLI's default system prompt includes:
...
Output styles are saved configurations that modify Gemini's system prompt. They're stored as markdown files and can be reused across sessions and projects.
...
// User-level: ~/.gemini/output-styles
// Project-level: .gemini/output-styles
const outputStylesDir = join(homedir(), '.gemini', 'output-styles')
...
async def create_output_style(name: str, description: str, prompt: str):
    # User-level: ~/.gemini/output-styles
    # Project-level: .gemini/output-styles
    output_styles_dir = Path.home() / '.gemini' / 'output-styles'
...
- **Settings**: `.gemini/settings.local.json`
...
- Complete control over Gemini's behavior
...
- [Output styles](/en/docs/gemini-code/output-styles) - Complete output styles documentation
- [TypeScript SDK guide](/en/docs/gemini-code/sdk/sdk-typescript) - Complete SDK usage guide
- [TypeScript SDK reference](/en/docs/gemini-code/typescript-sdk-reference) - Full API documentation
- [Configuration guide](/en/docs/gemini-code/configuration) - General configuration options
