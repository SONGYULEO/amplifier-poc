...
> Build and integrate custom tools to extend Gemini CLI SDK functionality

Custom tools allow you to extend Gemini CLI's capabilities with your own functionality through in-process MCP servers, enabling Gemini to interact with external services, APIs, or perform specialized operations.
...
<CodeGroup>
  ...
  import { query, tool, createSdkMcpServer } from "@anthropic-ai/gemini-code";
  import { z } from "zod";
...
```python Python
from gemini_code_sdk import tool, create_sdk_mcp_server, GeminiSDKClient, GeminiCodeOptions
...
When MCP tools are exposed to Gemini, their names follow a specific format:
...
You can control which tools Gemini can use via the `allowedTools` option:
...
// Optionally specify which tools Gemini can use
allowedTools: [
...
# Use the custom tools with Gemini
...
```python Python
from gemini_code_sdk import GeminiSDKClient, GeminiCodeOptions, tool, create_sdk_mcp_server
from typing import Any
import asyncio
...
- [TypeScript SDK Reference](/en/docs/gemini-code/sdk/typescript)
- [Python SDK Reference](/en/docs/gemini-code/sdk/python)
- [MCP Documentation](https://modelcontextprotocol.io)
- [SDK Configuration](/en/docs/gemini-code/sdk/sdk-configuration)
