# Gemini CLI Documentation Context

This directory contains documentation pages from [Anthropic's Gemini CLI documentation](https://docs.anthropic.com/) that have been downloaded for AI context and reference.

## Purpose

These files serve as authoritative documentation for Gemini CLI features, allowing AI assistants to provide accurate information about Gemini CLI capabilities, settings, and usage patterns without needing to access the web for common queries.

## File Naming Convention

Files are named based on their URL path from the docs site:

- URL: `https://docs.anthropic.com/en/docs/gemini-code/settings#tools-available-to-gemini`
- Filename: `GEMINI_CODE_SETTINGS.md`
...
- Treat content as current, valid Gemini CLI documentation
