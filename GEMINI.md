...
- Create "recipes" for dependable workflow execution that are "more code than model"
  - Orchestrates the use of the Gemini sub-agents for subtasks, using code where more structure is beneficial
  - Reserve use of Gemini sub-agents for tasks that are hard to codify
